    ...
    <?php echo output_errors($errors); ?>
        <div class="forms">
	      <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                ...
                <div class="form-body">
                    <form class="form-horizontal" name="task_form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-4">
                                <input type="datetime-local" class="form-control" id="focusedinput" name="start_time" value="<?php echo isset($_POST['start_time'])? $_POST['start_time'] : ''; ?>"  required="required">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">Stop Time </label>
							<div class="col-sm-4">
                                <input type="datetime-local" class="form-control" id="focusedinput" name="stop_time" value="<?php echo isset($_POST['stop_time'])? $_POST['stop_time'] : ''; ?>"  required="required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-4">
								<textarea type="text" class="form-control" id="focusedinput" name="notes"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-4">
								<textarea type="text" class="form-control" id="focusedinput" name="description"></textarea>
                            </div>
                        </div>

                    <div class="form-group">
                    	<div class="col-sm-offset-2 col-sm-10">
                    		<button type="submit" name="add_task" class="btn btn-primary btn-lg text-center">Submit</button>
                    	</div>
	                </div>
                    </form>
                </div>
