...
function get_country($id) {
    global $conn;
    $sql="SELECT * FROM `forign_destinations` WHERE `id` ='".$id."' AND `active` = '1'";
...
function wdestList($orderby) {
    global $conn;
    $sql = "SELECT * FROM forign_destinations WHERE active = '1' ORDER BY id $orderby ";
...
function add_country($table,$register_data){
...
function get_emb($id){
    global $conn;
    $sql="SELECT * FROM `embassy` WHERE `id` ='".$id."' AND `active` = '1' ";
    $result = mysqli_query($conn, $sql);
...
function embassyList($orderby) {
    global $conn;
    $sql = "SELECT * FROM embassy WHERE active = '1' ORDER BY id $orderby ";
...
function add_embassy($table,$register_data){
    $result =rowInsert($table, $register_data);
    if ($result == true) {
        return true;
    }else{
...
function get_testimonial($id){
    global $conn;
    $sql="SELECT * FROM `testimonials` WHERE `id` ='".$id."' AND `active` = '1' ";
    $result = mysqli_query($conn, $sql);
...
function testimonials($orderby) {
    global $conn;
    $sql = "SELECT * FROM testimonials WHERE active = '1' ORDER BY id $orderby ";
...
function add_testimonial($table,$register_data){
    $result =rowInsert($table, $register_data);
    if ($result == true) {
        return true;
    }else{
...
function hospitalsList($orderby) {
    global $conn;
    $sql = "SELECT * FROM hospitals WHERE active = '1' ORDER BY id $orderby ";
...
function add_hospital($table,$register_data){
    $result =rowInsert($table, $register_data);
    if ($result == true) {
        return true;
    }else{
